        ...
        >
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Button
              ...
              asChild
            >
              <Link href="/auth">Crear evento</Link>
            </Button>
          </div>
      ...
      >
        <div className="flex flex-col h-full px-8 pt-28 pb-8">
          ...
          >
            ...
            <Button className="flex-1 bg-foreground text-background rounded-full h-14 text-base" asChild onClick={() => setIsMobileMenuOpen(false)}>
              <Link href="/auth">Crear evento</Link>
            </Button>
          </div>
        </div>
